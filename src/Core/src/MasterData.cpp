...
static const std::vector<TitleBonus> g_titleBonuses = {
    ...
    // --- ステータス3種上昇称号 ---
    // STR/DEX/VIT
    {46, "胆気 (STR/DEX/VIT+20%)", false, {20, 20, 20, 0, 0, 0}},
    {47, "闘気 (STR/DEX/VIT+25%)", false, {25, 25, 25, 0, 0, 0}},
    {48, "覇気 (STR/DEX/VIT+30%)", true,  {30, 30, 30, 0, 0, 0}},

    // INT/CON/MEN
    {49, "恩恵 (INT/CON/MEN+20%)", false, {0, 0, 0, 20, 20, 20}},
    {50, "慈恵 (INT/CON/MEN+25%)", false, {0, 0, 0, 25, 25, 25}},
    {51, "天恵 (INT/CON/MEN+30%)", true,  {0, 0, 0, 30, 30, 30}},

    // --- ステータス4種上昇称号 ---
    {52, "制抑 (STR/DEX/INT/CON+15%)", false, {15, 15, 0, 15, 15, 0}},
    {53, "制圧 (STR/DEX/INT/CON+20%)", false, {20, 20, 0, 20, 20, 0}},
    {54, "制覇 (STR/DEX/INT/CON+30%)", true,  {30, 30, 0, 30, 30, 0}},

    // --- ステータス6種上昇称号 ---
    {55, "多能 (全+10%)", false, {10, 10, 10, 10, 10, 10}},
    {56, "万能 (全+15%)", false, {15, 15, 15, 15, 15, 15}},
    {57, "全能 (全+20%)", true,  {20, 20, 20, 20, 20, 20}}
};
